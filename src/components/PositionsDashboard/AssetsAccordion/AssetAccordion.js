...
const AssetAccordion = ({ removeSelectedAsset }) => {
  ...
  return (
    <div className={classes.root}>
      {selected.map((asset) => {
        const shares = shareCalcEngine(accInfo, selected).find(
          (el) => el.rowId === asset.rowId
        );
        return (
              ...
              >
                <div className={classes.bar}>
                  ...
                  <Typography className={classes.secondaryHeading}>
                    {`No of shares: ${shares.noOfShares} Target Price: $${asset.targetPrice} Stop Loss Price: $${asset.stopLossPrice}`}
                  </Typography>
                </div>
              </ExpansionPanelSummary>
              <ExpansionPanelDetails>
                <AssetContainer rowId={asset.rowId} />
              </ExpansionPanelDetails>
            </ExpansionPanel>
          </React.Fragment>
        );
